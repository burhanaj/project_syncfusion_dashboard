...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg  text-md text-gray-700 dark:ttext-gray-200 dark:hover:text-black hover:bg-light-gray m-2';
